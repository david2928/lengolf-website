...
Pot bunkers — deep, steep-faced, and strategically positioned to catch half-missed approaches — are the signature defense mechanism. Water hazards also appear on most holes, adding a second layer of strategic complexity. The greens are fast, well-maintained Tiff Dwarf bermuda surfaces. Peak condition is maintained in the cool dry season (November–March).`,
  ...
  locales: {
    ...
    th: {
      title: `Royal Chiang Mai Golf Club & Resort — แพ็กเกจรวมทุกอย่าง สนามฝีมือ Peter Thomson และเช่าไม้กอล์ฟ`,
...
พอตบังเกอร์ ซึ่งลึก ขอบชัน และวางไว้อย่างมีกลยุทธ์เพื่อดักช็อตเข้ากรีนที่พลาดครึ่ง ๆ กลาง ๆ คือกลไกป้องกันประจำสนาม นอกจากนี้ยังมีอุปสรรคน้ำปรากฏในหลุมส่วนใหญ่ ซึ่งเพิ่มความซับซ้อนเชิงกลยุทธ์อีกชั้นหนึ่ง กรีนเป็นพื้นผิวหญ้าเบอร์มิวดาพันธุ์ Tiff Dwarf ที่เร็วและได้รับการดูแลอย่างดี โดยสภาพสนามอยู่ในจุดสูงสุดในฤดูหนาวที่อากาศเย็นและแห้ง (พฤศจิกายนถึงมีนาคม)`,
    ...
    ja: {
      ...
      prose: {
        ...
        layout_and_experience: `6,969ヤードというThomsonの設計は現代の距離感で見れば控えめで、ブラックティーも設けられていません。難しさは長さではなく戦略的な配置から生まれます。コースは樹木に厚く囲まれ、木々に挟まれた通路が、球筋を作れないティーショットに容赦なく罰を与えます。フェアウェイは平坦ではなくうねっており、Thomsonは谷底の自然な傾斜を取り込むことで、アプローチのライに影響する微妙な地表のハザードを作り出しました。
...
深く、面が切り立ち、中途半端に外したアプローチをとらえる位置に配されたポットバンカーが、このコースの象徴的な防御装置です。加えてウォーターハザードもほとんどのホールに現れ、戦略上の複雑さをもう一段階加えています。グリーンは手入れの行き届いたティフドワーフ・バミューダ芝の速い面。コンディションが最も良いのは、涼しく乾いた11月から3月の時期です。`,
    ...
    ko: {
      ...
      prose: {
        ...
        layout_and_experience: `6,969야드라는 Thomson의 설계는 현대의 거리 감각으로 보면 길지 않고 블랙 티도 없지만, 어려움은 길이가 아니라 전략적인 배치에서 나와요. 코스는 나무에 빽빽하게 둘러싸여 있어 구질을 만들지 않은 티샷은 통로에서 벌을 받습니다. 페어웨이는 평평하지 않고 굽이치는데, 계곡 바닥의 자연스러운 경사를 설계에 끌어들여 어프로치의 라이에 영향을 주는 미묘한 지표면 해저드를 만들어 냈어요.
...
깊고 면이 가파르며 어중간하게 빗나간 어프로치를 잡아내는 자리에 놓인 포트 벙커가 이 코스의 상징적인 방어 장치예요. 여기에 워터 해저드도 대부분의 홀에 나타나 전략적 복잡함을 한 겹 더합니다. 그린은 잘 관리된 Tiff Dwarf 버뮤다그래스의 빠른 면이에요. 컨디션이 가장 좋은 때는 시원하고 건조한 11월부터 3월입니다.`,
    ...
    zh: {
      ...
      prose: {
        overview: `Royal Chiang Mai Golf Club & Resort是泰国北部故事最多的球场之一：一套由五届英国公开赛（British Open）冠军Peter Thomson设计、1996年2月开放的18洞标准杆72球场。球场坐落在清迈市区以北约40公里、San Sai县Mae Faek一带的山谷之中，构想上是一套糅入林克斯元素的英式园林布局——罐式沙坑、贴地滚进的攻果岭球，以及回报地面打法而非纯粹空中攻旗的起伏球道。场地从前是一片果园，留存下来的成材大树，给这套布局带来了同龄球场少见的尺度感与荫凉。四周的山脊为球场镶边，整轮球都有优美的山景作背景。`,
...
罐式沙坑——又深、面又陡，位置专门用来收下打偏一半的攻果岭球——是这座球场的招牌防守机制。大多数洞上还有水障碍，又叠上一层战术复杂度。果岭是维护良好、速度偏快的Tiff Dwarf百慕大草面。状态最好的时候是凉爽干燥的11月至次年3月。`,
        tips: `请到royalchiangmai.com或通过预订平台确认当前价格：旺季约4,800泰铢的全包价已含球童与球车。选定攻击线之前，先请球童根据码数手册讲解罐式沙坑的位置。这座球场回报准头多过距离，发球台上保守一些，能降低吞下双柏忌的风险。上午的球局更凉快，11月至次年1月山谷里的晨雾还会添上独特的氛围。`,
