...
export const course: GolfCourse = {
  ...
  locales: {
    ...
    th: {
      ...
      prose: {
        overview: `Hang Dong Golf Club Chiangmai เป็นสนาม 9 หลุม (พาร์ 36 ระยะ 2,751 หลา) ในอำเภอหางดง ทางใต้ของเชียงใหม่ เป็นสนามสาธารณะที่เน้นความคุ้มค่า ด้วยค่ากรีนฟีที่ย่อมเยามาก อยู่ที่ประมาณ 250 บาทสำหรับ 9 หลุมพร้อมแคดดี้ (ข้อมูล ณ กรกฎาคม 2026) สนามอยู่ห่างจากสนามบิน CNX ประมาณ 15 นาที และให้บริการชาวเชียงใหม่ในพื้นที่เป็นหลัก รวมถึงนักกอล์ฟที่มองหาการออกรอบสั้น ๆ ในราคาประหยัด สนามมีอุปสรรคน้ำในหลายหลุม รวมถึงกรีนลักษณะเกาะกลางน้ำที่หลุม 8`,
    ...
    zh: {
      ...
      prose: {
        ...
        tips: `打9洞连球童约250泰铢，另加200泰铢球童小费，是清迈一带最超值的高尔夫，截至2026年7月。球杆租借按全包价约350–450泰铢。这里最适合在CNX下午稍晚的航班之前快打一场。球场没有官方网站，出发前请先联系球场确认当前费用。`,
