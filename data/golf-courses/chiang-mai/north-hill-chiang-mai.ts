  ...
  locales: {
    ...
    th: {
      ...
      prose: {
        ...
        layout_and_experience: `เดิมสนามแห่งนี้เป็นสโมสรส่วนตัวขนาด 9 หลุม และการขยายเป็น 18 หลุมได้สร้างเลย์เอาต์สไตล์พาร์กแลนด์ที่มีอุปสรรคน้ำและบังเกอร์กระจายอยู่ตลอดสนาม ระยะรวม 6,789 หลาถือว่ารับมือได้สบายสำหรับผู้เล่นส่วนใหญ่เมื่อเล่นจากแท่นทีหลังสุด ทำเลในอำเภอหางดงทำให้สนามอยู่บนภูมิประเทศราบเรียบถึงลาดเอียงเล็กน้อย ส่วนสนามไดรฟ์ของ North Hill โดดเด่นทั้งในแง่คุณภาพและความหลากหลายของสิ่งอำนวยความสะดวก`,
    ...
    ko: {
      ...
      prose: {
        ...
        tips: `올인클루시브 그린피 패키지(캐디와 카트를 포함해 약 3,400바트)라면 예산도 세우기 쉬워요. 현재 요금은 공식 웹사이트(northhillchiangmai.com)에서 확인하고 예약하세요. CNX 공항에서 15분이면 닿는 거리라, 치앙마이 골프 여행의 첫 라운딩이나 마지막 라운딩으로 삼기에 이상적입니다. 고급 드라이빙 레인지는 라운딩 전 몸을 푸는 데도 좋은 선택지예요.`,
    ...
    zh: {
      ...
      prose: {
        overview: `North Hill Golf Club Chiang Mai是清迈一带最新建成的18洞球场，2015年11月从9洞扩建为完整的18洞布局。球场位于Hang Dong县Ban Waen，距清迈国际机场以南约15分钟，对落地CNX的旅客而言，是位置最便利的球场之一。它作为North Hill City Resort综合体的一部分运营，园区内还有水疗、健身中心、高规格练习场、酒吧与餐厅。以6,789码、标准杆72的规格，这是一套中等长度的布局，适合各种差点的球手。`,
        ...
        tips: `全包果岭费套餐约3,400泰铢，含球童与球车，让预算好算得多。请通过官方网站（northhillchiangmai.com）查看当前价格并预订。距CNX机场只有15分钟，这里很适合安排成清迈高尔夫行程的第一场或最后一场球。高规格的练习场，也是下场前热身的好选择。`,
