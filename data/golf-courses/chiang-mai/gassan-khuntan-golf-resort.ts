...
export const course: GolfCourse = {
  ...
  fee_is_package: true,
  // Zero, not 300/750: EN states the 4,200 covers an all-inclusive rate, and
  // its ONLY mention of 300 is "Caddie tips of 300-500 THB per round" — the tip
  // floor, mis-typed as a fee. No cart fee is stated anywhere in EN. Publishing
  // 300 made the generated FAQ and FAQPage JSON-LD assert a caddie charge on a
  // page whose body copy calls the same rate all-inclusive.
  caddie_fee_thb: 0,
  cart_fee_thb: 0,
...
ピークシーズン（11月から3月）はコースが最も混み合い、プレー進行が遅くなることもあります。快適なペースと、山あいの開けた場所に昼の暑さが溜まる前の涼しい時間帯を確保するため、7:00から8:00の朝のティータイムを強くおすすめします。`,
        ...
        location_and_access: `Gassan Khuntan Golf & Resortはランプーン県メーター郡にあり、チェンマイ国際空港（CNX）から南へおよそ45分、チェンマイ中心部からは車で約1時間の距離です。バンコクからの来訪者はCNXへ空路で向かい（スワンナプームまたはドンムアンから約1時間10分）、バンコクから700kmを車で走るのはゴルフ旅行として現実的ではありません。チェンマイ市街からは自家用車かGrabでアクセスでき、11号線（旧チェンマイ・ランプーン道路）を南下してランプーンの街を抜けたのち、山側へ折れていきます。`,
...
성수기(11월부터 3월)에는 코스가 가장 붐벼 진행 속도가 느려지기도 해요. 편안한 페이스와, 한낮의 열기가 산자락 공터에 쌓이기 전의 시원한 시간대를 확보하려면 오전 7:00~8:00 티타임을 강력히 권합니다.`,
    ...
    zh: {
      ...
      prose: {
        overview: `Gassan Khuntan Golf & Resort是一座位于南奔府的27洞山林球场，从清迈国际机场往南约45分钟车程。球场由泰国北部最具分量的高尔夫品牌Gassan Golf Group运营，布局分成三组性格分明的9洞环线，分别名为White Bridge（A场）、River（B场）与Mountain（C场）。主要的18洞组合打标准杆72，全长约7,062码。这里的场景在泰国北部堪称最富自然野趣：球场被Doi Khuntan国家公园覆满森林的山脊环抱，好几个洞打起来始终以山影为背景。这种僻静的山地氛围，把Gassan Khuntan和更靠近清迈市区、往来方便的度假村球场区分开来，也为它赢得了Gassan集团旗下最野、最具冒险感的名声。想从山谷园林式布局换换口味的球手，会觉得这里粗犷的地形与居高的舞台是个很有说服力的选择。`,
...
整座球场用的是自然地貌，而不是大动土方，因此球道顺着地形起伏、弯折。主要的防守手段是草坑与陡峭边坡的障碍，传统沙坑的分量不如海拔较低的度假村球场那么重。果岭紧实、滚动真实，但坡度细微，听从当地球童的建议会有回报。Gassan Khuntan的球童团队因为熟悉这套非有经验不易打出好成绩的布局，一向口碑不错。
...
旺季（11月至次年3月）球场最热闹，打球节奏可能变慢。为了拿到舒服的节奏，也为了赶在正午暑气在山间空地上累积起来之前下场，强烈建议订7:00至8:00的上午开球时间。`,
        ...
        location_and_access: `Gassan Khuntan Golf & Resort位于南奔府Mae Tha，距清迈国际机场（CNX）以南约45分钟车程，距清迈市中心约1小时。从曼谷前来的访客飞往CNX，自素万那普机场或廊曼机场出发约1小时10分钟——从曼谷开车700公里对高尔夫行程并不实际。从清迈市区可以自驾或叫Grab前往，路线沿11号公路（旧清迈至南奔公路）南下穿过南奔市区，再折向山区。`,
