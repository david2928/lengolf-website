...
แคดดี้ที่ Chiangmai Highlands มีประสบการณ์และเชี่ยวชาญการคำนวณระยะที่ปรับตามความสูงต่ำซึ่งกอล์ฟบนภูเขาต้องการ การฟังคำแนะนำของแคดดี้ในช็อตเข้ากรีน โดยเฉพาะเมื่อเล่นขึ้นเนินหรือลงเนิน จะช่วยลดสกอร์ได้ตลอดทั้งรอบ ผู้เล่นแต่ละคนจะได้แคดดี้หนึ่งคนและรถกอล์ฟหนึ่งคัน โดยแคดดี้เป็นผู้ขับ ซึ่งช่วยให้จังหวะการเล่นลื่นไหล ทั้งนี้สนามไม่มีนโยบายคืนเงินหรือเลื่อนรอบเมื่อฝนตก หมายความว่ารอบที่ถูกสภาพอากาศขัดจังหวะจะไม่ได้รับเงินคืน ซึ่งเป็นข้อที่ควรพิจารณาตอนจอง`,
    ...
    ja: {
      ...
      meta_description: `グリーンフィーは3,400THB。Chiangmai Highlands Golf & Spa Resortはチェンマイ市街から東へ40kmのメーオン郡にある18ホールのコースで、設計はSchmidt-Curley Design、チャンピオンシップティーから7,227ヤードです。バンコクのホテルへ届くLENGOLFのクラブレンタルもご案内します。`,
      prose: {
...
Chiangmai Highlandsのキャディーは経験豊富で、山岳ゴルフに欠かせない高低差を加味した距離計算にも通じています。とくに打ち上げや打ち下ろしのアプローチでキャディーの助言に従えば、ラウンド全体でスコアを節約できるはずです。プレーヤー1人につきキャディー1人とカート1台が付き（運転はキャディーが担当）、これがテンポのよいラウンドにつながっています。なお、このコースには雨天時のレインチェック制度がなく、天候で中断したラウンドの返金はありません。予約の際に頭に入れておきたい点です。`,
    ...
    ko: {
      ...
      prose: {
        overview: `Chiangmai Highlands Golf & Spa Resort 코스는 치앙마이 시내에서 동쪽으로 40km 떨어진 매온군 산속에 자리한 18홀 챔피언십 코스예요. 설계는 태국에서 가장 높은 평가를 받는 코스들을 여럿 맡아 온 미국 설계 사무소 Schmidt-Curley Design에서 담당했고, 2005년에 문을 열었습니다. 굽이치는 고지대 지형 위에 조성된 Chiangmai Highlands 코스는 패스팔럼 페어웨이와 Tifeagle 퍼팅 그린으로 일 년 내내 고른 플레이 표면을 유지하며, 레이아웃 전체에 100개가 넘는 벙커가 흩어져 있어요. 챔피언십 티에서의 전장은 7,227야드입니다. 평평한 리조트형 파크랜드가 아니라 진짜 고지대의 무대를 찾는 골퍼들에게 특히 사랑받으며, 태국 북부를 대표하는 골프 경험으로 꾸준히 소개돼요. 부지 안에는 풀서비스 스파와 숙소, 클럽하우스 레스토랑이 갖춰져 있어 라운딩과 매온 산자락의 풍경을 함께 즐기는 며칠간의 체류에도 잘 맞습니다.`,
...
Chiangmai Highlands 코스의 캐디들은 경험이 많고, 산악 골프에 꼭 필요한 고저 차를 반영한 거리 계산에도 밝아요. 특히 오르막이나 내리막 어프로치에서 캐디의 조언을 따르면 라운딩 전체에서 타수를 아낄 수 있습니다. 플레이어 한 명당 캐디 한 명과 카트 한 대가 배정되고 운전은 캐디가 맡아, 진행 속도도 경쾌한 편이에요. 다만 이 코스에는 우천 시 레인 체크 제도가 없어서 날씨로 중단된 라운딩은 환불되지 않으니, 예약할 때 염두에 두면 좋아요.`,
    ...
    zh: {
      title: `Chiangmai Highlands Golf & Spa Resort果岭费 — 清迈山地18洞攻略与球杆租借`,
      meta_description: `Chiangmai Highlands Golf & Spa Resort果岭费3,400泰铢。这座18洞锦标赛球场位于清迈以东40公里的Mae On山中，由Schmidt-Curley Design设计，锦标赛发球台全长7,227码，另附送到曼谷酒店的LENGOLF球杆租借。`,
      prose: {
        overview: `Chiangmai Highlands Golf & Spa Resort是一座18洞锦标赛球场，坐落在清迈市区以东40公里Mae On县的群山之中。球场出自美国设计事务所Schmidt-Curley Design之手——泰国多座备受赞誉的球场都由这家事务所打造——并于2005年开放。球场建在起伏的高地地形上，采用海滨雀稗（Paspalum）球道与Tifeagle果岭，全年都能提供稳定的击球面，整套布局散布着超过100个沙坑。从锦标赛发球台量起全长7,227码。这里常被列入泰国北部最出色的高尔夫体验之列，尤其受到那些想要真正高地舞台、而非平坦度假村园林球场的球手青睐。场内设施包括完整的水疗中心、住宿与会馆餐厅，很适合把打球与Mae On群山自然景致结合起来的多日行程。`,
        layout_and_experience: `Chiangmai Highlands在山地地形上展开，从第一个发球台起，高低落差与山谷视野就定义了整场体验。Schmidt-Curley的设计充分利用了自然地貌：球道随山丘的等高线起落，好几个洞都需要精准选杆来抵消明显的高差。海滨雀稗球道能稳稳托住球，即便在雨季也能给出可靠的球位，Tifeagle果岭则始终又快又匀。

18个洞散布着超过100个沙坑，Chiangmai Highlands因此全程要求精准的攻果岭球。3杆洞尤其不留情面，沙坑就守在目标偏短或偏外的位置上。第18洞以一记要求果断击球的高难度攻果岭球，构成令人难忘的收尾考验。从锦标赛发球台（7,227码，标准杆72）打，这座球场对低差点球手是货真价实的考验；而6,287码的白色发球台与5,739码的黄色发球台，则让中差点球手也能应付这套布局。

Chiangmai Highlands的球童经验丰富，对山地高尔夫必备的高差修正距离计算也很熟稔——在攻果岭球上听从球童的建议，尤其是上坡或下坡时，一轮打下来能省下不少杆数。每位球员配一位球童和一辆球车，由球童驾驶，打球节奏因此相当顺畅。球场不设雨天顺延政策，也就是说被天气打断的球局不会退款，订场时值得留意。`,
        tips: `11月至次年2月是打Chiangmai Highlands最好的时候：清晨气温降到15–22°C，球道也在雨季结束后处于最佳状态。11月至次年3月的旺季请订清晨的开球时间，才能拿到最好的条件。雨季（6月至10月）球道青翠，但午后常有雷阵雨，上午的球局通常能在好天气里打完。球童费与球车费为强制项目，且须以泰铢现金支付；结束后给球童400泰铢以上的小费是常规做法。球场不设雨天顺延政策，因此旺季前来时，投保一份涵盖天气导致取消球局的旅游保险值得考虑。着装要求有领衬衫，圆领T恤与牛仔布均不允许。想把球局与高地度假结合起来的人，场内也有住宿。从清迈出发请安排Grab或酒店用车——通往Mae On的道路蜿蜒，公共交通也不算便利。`,
        location_and_access: `Chiangmai Highlands Golf & Spa Resort位于Mae On县，距清迈市中心向东约40分钟车程。从曼谷前来的人几乎都选择飞行——从素万那普机场（BKK）或廊曼机场（DMK）飞到清迈（CNX）约1小时10分钟。从曼谷到这里的公路距离约720公里，开车对高尔夫行程并不实际。到了清迈之后，可以叫Grab或自驾前往度假村，路线自市中心沿11号公路向东。度假村也可以应要求安排接驳车。`,
        rental_cta_context: `打算到山中的Chiangmai Highlands打一场吗？LENGOLF在曼谷提供品质可靠的租借球杆套组，登机前送到你的酒店，让你轻装出行，也不必支付航空公司的行李费用。`,
      },
    },
  },
  status: 'published',
