...
Chiangmai Highlands的球童经验丰富，对山地高尔夫必备的高差修正距离计算也很熟稔——在攻果岭球上听从球童的建议，尤其是上坡或下坡时，一轮打下来能省下不少杆数。每位球员配一位球童和一辆球车，由球童驾驶，打球节奏因此相当顺畅。球场不设雨天顺延政策，也就是说被天气打断的球局不会退款，订场时值得留意。`,
        ...
        location_and_access: `Chiangmai Highlands Golf & Spa Resort位于Mae On县，距清迈市中心向东约40分钟车程。从曼谷前来的人几乎都选择飞行——从素万那普机场（BKK）或廊曼机场（DMK）飞到清迈（CNX）约1小时10分钟。从曼谷到这里的公路距离约720公里，开车对高尔夫行程并不实际。到了清迈之后，可以叫Grab或自驾前往度假村，路线自市中心沿11号高速公路向东。度假村也可以应要求安排接驳车。`,
