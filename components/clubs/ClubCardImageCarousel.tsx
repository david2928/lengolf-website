...
export default function ClubCardImageCarousel({ imageUrl, imageUrls, alt }: ClubCardImageCarouselProps) {
  ...
  if (images.length === 0) {
    return (
      <div className="aspect-[4/3] w-full bg-muted/30 flex items-center justify-center rounded-t-xl">
  ...
  return (
    <div className="relative aspect-[4/3] w-full overflow-hidden rounded-t-xl bg-muted/10">
      <Image
        src={images[0]}
        alt={alt}
        fill
